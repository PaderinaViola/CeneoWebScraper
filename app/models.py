...
class Product:
    ...
    def extract_opinions(self):
        ...
        while url:
            ...
            if response.status_code == 200:
                ...
                try:
                    url = "https://www.ceneo.pl"+extract_data(page_dom.select_one, "a.pagination__next", "href")
                except TypeError:
                    url = None
    ...
    def calculate_stats(self):
        ...
        self.stats["recommendations"] = opinions.recommend.value_counts(dropna=False).reindex([True, False, None], fill_value=0).to_dict()
...
class Opinion:
    ...
    def translate(self):
        ...
        self.pros_en["cons_en"] = [translate_data(cons) for cons in self.cons_pl]
        return self
